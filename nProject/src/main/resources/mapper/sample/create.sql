...
(
  ...
  JOIN_DT_TM TIMESTAMP COMMENT '가입 일시' ,
  ...
  CERT_DT_TM TIMESTAMP COMMENT '인증 일시' ,
  LEAVE_REASON VARCHAR(500) COMMENT '탈퇴 사유' ,
  LEAVE_DT_TM TIMESTAMP COMMENT '탈퇴 일시' ,
  USE_YN VARCHAR(2) COMMENT '사용 여부' ,
  REG_DT_TM TIMESTAMP COMMENT '등록 일시' ,
...
(
  ...
  USE_YN VARCHAR(2) COMMENT '사용 여부' ,
  REG_DT_TM TIMESTAMP COMMENT '등록 일시' ,
  CHG_DT_TM TIMESTAMP COMMENT '변경 일시' ,
