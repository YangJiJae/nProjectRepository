...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/join/comjoin_form.css'/>" />
...
$(document).ready(function(){
	...
	function EventTot2(){
		...
		joinBtn.onclick=function(){
			...
			&& agreetot=="yes" && idok=="yes" && officeTelok=="yes"){
				var comSubmit = new ComSubmit();//comjoin_form_form
				comSubmit.setUrl("<c:url value='/comJoinGo.do' />");
				comSubmit.addParam("NAME", $("#comjoin_form_comCaptainName").val());
				comSubmit.addParam("COM_NM", $("#comjoin_form_comOfficName").val());
				comSubmit.addParam("ADDRESS", $("#comjoin_form_comOfficAddress").val());
				comSubmit.addParam("TEL_NUM", $("#comjoin_form_comOfficTel").val());
				comSubmit.addParam("PHONE_NUM", $("#comjoin_form_comTel").val());
				comSubmit.addParam("EMAIL", $("#comjoin_form_comEmail").val());
				comSubmit.addParam("COM_ID", $("#comjoin_form_comId").val());
				comSubmit.addParam("PWD", $("#comjoin_form_comPw").val());
				comSubmit.submit();
			}else{
				if(agreetot=="no"){
	...
	function emCheck(){
		...
		comAjax.addParam("ID",$("#comjoin_form_comEmail").val());
		comAjax.addParam("SEL", "company");
		comAjax.ajax();
	}
	...
	function phoneCheck(){
		...
		comAjax.addParam("ID",$("#comjoin_form_comTel").val());
		comAjax.addParam("SEL", "company");
		comAjax.ajax();
	}
